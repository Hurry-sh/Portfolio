...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Harish K
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description">
                Hey! My name is Harish K and I am a student of PES University Electronic City Campus, Bengaluru. I am a developer and my field of interest is in Machine Learning and Artificial Intelligence. Welcome to my portfolio!😊
            </p>
